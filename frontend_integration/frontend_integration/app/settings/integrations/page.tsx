...
export default function IntegrationsPage() {
  ...
  const testMutation = useMutation({
    mutationFn: async (integration: WebhookIntegration) => {
      const response = await integrationApi.test(
        integration.webhook_url, 
        integration.webhook_secret || undefined
      );
      return response.data;
    }
  });
          ...
          {integrations && integrations.length > 0 ? (
            integrations.map((integration: WebhookIntegration) => (
              ...
              >
                ...
                {testMutation.data && testMutation.variables?.id === integration.id && (
                  <div className={cn(
